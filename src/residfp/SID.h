...
public:
    ...
    /**
     * Get current envelope amplitude (0..255) for voice v.
     * Added for goattracker2 Qt frontend per-channel VU meters.
     */
    uint8_t envelopeLevel(int v) { return voice[v].envelope()->output(); }
